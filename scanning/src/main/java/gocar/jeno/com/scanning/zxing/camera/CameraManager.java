...
package gocar.jeno.com.scanning.zxing.camera;
...
public final class CameraManager {
    ...
    /**
     * 生成矩形扫描框 Calculates the framing rect which the UI should draw to show the
    ...
    public Rect getFramingRect() {
        if (framingRect == null) {
            ...
            int topOffset = (screenResolution.y - height) / 3;//之前 是  5      4
